...
def find_cohort_by_student_name(student_list):
    ...
    # student_list[0] 
    input_name = input("What is your first and last name?")
    for student in student_list:
        if input_name == student[0]:
            cohort = student[3]
            return '{} was in the {}'.format (input_name, cohort)
